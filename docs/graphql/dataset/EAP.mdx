...
## Authorizing Requests on EAP

EAP uses the same authorization mechanism as V2 APIs. See how to generate a token [here](https://docs.bitquery.io/docs/authorisation/how-to-generate/)
